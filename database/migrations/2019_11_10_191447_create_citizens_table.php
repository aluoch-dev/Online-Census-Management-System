...
class CreateCitizensTable extends Migration
{
    ...
    public function up()
    {
        Schema::create('citizens', function (Blueprint $table) {
            ...
            $table->bigInteger('field_id')->unsigned()->nullable()->default(5);
            $table->foreign('field_id')->references('id')->on('study_fields');
            $table->bigInteger('disability_id')->unsigned()->nullable()->default(4);
            $table->foreign('disability_id')->references('id')->on('disabilities');
            $table->foreign('education_id')->references('id')->on('education_levels');
            $table->bigInteger('employment_id')->unsigned()->nullable()->default(3);
            $table->foreign('employment_id')->references('id')->on('employment_statuses');
            $table->bigInteger('occupation_id')->unsigned()->nullable()->default(4);
            $table->foreign('occupation_id')->references('id')->on('occupations');
            $table->bigInteger('income_source')->unsigned()->nullable()->default(4);
